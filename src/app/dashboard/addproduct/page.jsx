  ...
  return (
    <div className="max-w-3xl mx-auto p-6 mt-8 bg-white dark:bg-gray-800 rounded-lg shadow-md transition-colors">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div>
          <label className="label">
            <span className="label-text font-medium text-gray-700 dark:text-gray-300">Comment</span>
          </label>
          <textarea
            placeholder="Additional comment"
            {...register("comment")}
            className="textarea textarea-bordered w-full bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100 border-gray-300 dark:border-gray-600"
          />
        </div>
        ...
        <div>
          <label className="label">
            <span className="label-text font-medium text-gray-700 dark:text-gray-300">Performance</span>
          </label>
          <select
